<template>
    <Box>
        ...
        <form @submit.prevent="upload">
            ...
            <div v-if="imageErrors.length" class="error">
    ...
    <Box v-if="listing.images.length" class="mt-4">
        ...
        <section class="mt-4 grid grid-cols-3 gap-4">
            ...
            >
                <img :src="image.src" class="w-full h-full object-cover" alt=""/>
                <Link
...
const page = usePage();
const imageErrors = computed(() => Object.values(page.props.errors))
